    ...
    tableBody.innerHTML = studentsCache.map(student => {
        ...
        return `
            <tr class="border-b dark:border-gray-700">
                ...
                <td class="p-3">${fee} ${settingsCache.currency}</td>
                <td class="p-3">
...
async function saveFinancials() {
    ...
    try {
        // Use bulkPut to efficiently add or update records based on the compound primary key
            ...
            <tbody>
                ${expenses.map(e => `
                    <tr class="border-b dark:border-gray-700">
                        ...
                        <td class="p-3">${e.amount} ${settingsCache.currency}</td>
